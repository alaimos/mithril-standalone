...
public class FastPathwayWriterThread extends Thread implements Runnable, AutoCloseable {
    ...
    public FastPathwayWriterThread(String name, Buffer<FastPerturbationIO> outputBuffer, File outputFile,
