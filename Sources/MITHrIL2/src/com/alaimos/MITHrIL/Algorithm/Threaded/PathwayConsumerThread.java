...
public class PathwayConsumerThread extends ConsumerThread<FastPerturbationIO, FastPerturbationIO> {

    private final ConcurrentFastPathway algorithm;

    public PathwayConsumerThread(ThreadGroup g, String name, Buffer<FastPerturbationIO> inputBuffer,
        ...
        this.algorithm = new ConcurrentFastPathway(sharedParameters);
        this.algorithm.init();
    }
