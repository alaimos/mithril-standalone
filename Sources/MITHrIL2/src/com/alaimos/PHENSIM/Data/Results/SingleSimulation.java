...
import com.alaimos.PHENSIM.Algorithm.WeightMatrixBuilder;
...
public class SingleSimulation {
    ...
    private final Map<PathwayInterface, WeightMatrixBuilder> builders = new HashMap<>();
    ...
    public void setBuilders(Map<PathwayInterface, WeightMatrixBuilder> builders) {
        this.builders.putAll(builders);
    }

    public Map<PathwayInterface, WeightMatrixBuilder> getBuilders() {
        return builders;
    }
